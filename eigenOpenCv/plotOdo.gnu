...
plot  "< tail -2000 logMain.csv" using 1:6  title 'pos x'  with lines , \
      ...
      "< tail -2000 log.csv"     using 1:6  title 'pos est x'  with lines , \
      "< tail -2000 log.csv"     using 1:7 title 'pos est y'  with lines , \
      "< tail -2000 log.csv"     using 1:8 title 'pos est z'  with lines
