...
{
	QuaternionAlias<double> q_a1 = QuaternionAlias( 1, 0, 0, 0 );
	QuaternionAlias<double> q_a2 = QuaternionAlias( 1, 0, 0, 0 );
	Quaternion<double> q1 = QuaternionAlias( 1, 0, 0, 0 );
	Quaternion<double> q2 = QuaternionAlias( 1, 0, 0, 0 );
